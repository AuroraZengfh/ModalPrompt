...
def eval_model(args):
    ...
    tokenizer, model, image_processor, context_len = load_pretrained_model(model_path, args.model_base, model_name, args.prefix_len, args.cur_task, args.text_tower)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cur-task", type=int)
