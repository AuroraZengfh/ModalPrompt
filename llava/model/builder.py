...
def load_pretrained_model(model_path, model_base, model_name, prefix_len, cur_task, text_tower, load_8bit=False, load_4bit=False, device_map="auto", device="cuda", **kwargs):
    ...
    if 'llava' in model_name.lower():
        ...
        if 'lora' in model_name.lower() and model_base is not None:
            ...
            from ModalPrompt.peft import PeftModel
            ...
            if 'mpt' in model_name.lower():
                ...
                model = Continual_LLAVA.from_pretrained(model_base, low_cpu_mem_usage=True, config=cfg_pretrained, **kwargs)
